            ...
            <div className="relative w-full max-w-lg rounded-3xl border border-white/20 bg-white/10 backdrop-blur-xl shadow-2xl shadow-black/40 p-8 animate-[scaleIn_.3s_ease]">
                ...
                <div className="flex flex-col flex-wrap gap-2 mb-8">
                    ...
                    <div className='text-white'>
                        {selectedJob.rolesAndResponsibilities.map((rnr, index) => <p className='ms-1 flex gap-1' key={rnr+index}>
                ...
                <a href={selectedJob.url} target='_blank' className="px-5 py-2 rounded-xl text-sm font-semibold bg-gradient-to-br from-cyan-400 to-indigo-500 text-black hover:scale-105 transition-all shadow-lg shadow-indigo-500/30">
                    Apply Now
                </a>
